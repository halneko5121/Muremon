...
namespace
{
  ...
  * @brief	コンストラクタ
  */
Mission9::Mission9(const MissionId& id, Texture* texture, Vertex* vertex)
...
Mission9::draw() const
{
	...
	{
		UtilGraphics::drawF(mVertex, Vector2f(96.0f + 29.5f * (i - 1), 278.0f), R_F_NIKUMAN);
	}
}
