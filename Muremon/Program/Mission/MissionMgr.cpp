...
void MissionMgr::draw() const
{
	...
	UtilGraphics::drawF(mVertex, mMissionStartPos, rect_index);	//みっしょん発生

	UtilGraphics::setVertexColor(mVertex, mAlpha,255,255,255);
	UtilGraphics::drawF(mVertex, cDispMissionAlertPos, R_MISSION_OSIRASE);	//みっしょんお知らせ枠
	UtilGraphics::drawF(mVertex, cDispMissionAlertPos, R_MISSION_1 + mCurrentMissionId);	//みっしょん
