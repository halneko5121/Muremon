...
namespace
{
	const int cSuccessTypingCount = 23;
  ...
  * @brief	コンストラクタ
  */
Mission5::Mission5(const MissionId& id, Texture* texture, Vertex* vertex)
...
Mission5::draw() const
{
	...
	{
		UtilGraphics::drawF(mVertex, Vector2f(76.0f + 28.5f * (i - 1), 278.0f), R_F_NIKUMAN);
	}
}
