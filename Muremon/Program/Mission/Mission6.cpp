...
namespace
{
	const int cSuccessTypingCount = 17;
  ...
  * @brief	コンストラクタ
  */
Mission6::Mission6(const MissionId& id, Texture* texture, Vertex* vertex)
...
Mission6::draw() const
{
	...
	{
		UtilGraphics::drawF(mVertex, Vector2f(118.0f + 29.5f * (i - 1), 278.0f), R_F_NIKUMAN);
	}
}
